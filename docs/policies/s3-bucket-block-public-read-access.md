...
This rule is covered by the [s3-bucket-block-public-read-access](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/s3/s3-bucket-block-public-read-access.sentinel) policy.
