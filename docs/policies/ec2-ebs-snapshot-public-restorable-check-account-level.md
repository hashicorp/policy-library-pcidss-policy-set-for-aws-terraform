...
This rule is covered by the [ec2-ebs-snapshot-public-restorable-check-account-level](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/ec2/ec2-ebs-snapshot-public-restorable-check-account-level.sentinel) policy.
