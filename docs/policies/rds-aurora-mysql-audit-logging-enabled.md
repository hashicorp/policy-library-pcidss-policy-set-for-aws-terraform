...
This rule is covered by the [rds-aurora-mysql-audit-logging-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/rds/rds-aurora-mysql-audit-logging-enabled.sentinel) policy.
