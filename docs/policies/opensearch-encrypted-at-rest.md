...
This rule is covered by the [opensearch-encrypted-at-rest](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/opensearch/opensearch-encrypted-at-rest.sentinel) policy.
