...
This rule is covered by the [ec2-vpn-connection-logging-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/ec2/ec2-vpn-connection-logging-enabled.sentinel) policy.
