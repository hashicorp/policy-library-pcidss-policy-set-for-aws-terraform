...
This rule is covered by the [s3-block-public-access-account-level](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/s3/s3-block-public-access-account-level.sentinel) policy.
