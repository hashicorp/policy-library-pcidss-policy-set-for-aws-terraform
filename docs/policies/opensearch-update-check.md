...
This rule is covered by the [opensearch-update-check](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/opensearch/opensearch-update-check.sentinel) policy.
