...
This rule is covered by the [ecr-tag-immutability-configured](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/ecr/ecr-tag-immutability-configured.sentinel) policy.
