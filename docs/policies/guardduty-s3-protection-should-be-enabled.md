...
This rule is covered by the [guardduty-s3-protection-should-be-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/guardduty/guardduty-s3-protection-should-be-enabled.sentinel) policy.
