...
This rule is covered by the [docdb-cluster-audit-logging-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/docdb/docdb-cluster-audit-logging-enabled.sentinel) policy.
