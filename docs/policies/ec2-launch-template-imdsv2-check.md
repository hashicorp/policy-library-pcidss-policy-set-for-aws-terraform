...
This rule is covered by the [ec2-launch-template-imdsv2-check](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/ec2/ec2-launch-template-imdsv2-check.sentinel) policy.
