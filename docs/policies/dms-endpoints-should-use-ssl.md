...
This rule is covered by the [dms-endpoints-should-use-ssl](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/dms/dms-endpoints-should-use-ssl.sentinel) policy.
