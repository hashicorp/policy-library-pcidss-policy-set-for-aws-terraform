...
This rule is covered by the [docdb-cluster-backup-retention-check](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/docdb/docdb-cluster-backup-retention-check.sentinel) policy.
