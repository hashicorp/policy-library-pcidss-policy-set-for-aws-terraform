...
This rule is covered by the [ecr-image-scanning-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/ecr/ecr-image-scanning-enabled.sentinel) policy.
