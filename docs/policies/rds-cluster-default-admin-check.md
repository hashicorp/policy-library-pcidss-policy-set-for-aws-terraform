...
This rule is covered by the [rds-cluster-default-admin-check](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/rds/rds-cluster-default-admin-check.sentinel) policy.
