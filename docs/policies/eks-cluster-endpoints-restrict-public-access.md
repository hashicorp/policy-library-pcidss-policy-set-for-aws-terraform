...
This rule is covered by the [eks-cluster-endpoints-restrict-public-access](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/eks/eks-cluster-endpoints-restrict-public-access.sentinel) policy.
