...
This rule is covered by the [msk-in-cluster-node-require-encrypted-in-transit](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/msk/msk-in-cluster-node-require-encrypted-in-transit.sentinel) policy.
