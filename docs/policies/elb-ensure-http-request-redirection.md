...
This rule is covered by the [elb-ensure-http-request-redirection](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/elb/elb-ensure-http-request-redirection.sentinel) policy.
