...
This rule is covered by the [api-gateway-access-logging-should-be-configured](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/api-gateway/api-gateway-access-logging-should-be-configured.sentinel) policy.
