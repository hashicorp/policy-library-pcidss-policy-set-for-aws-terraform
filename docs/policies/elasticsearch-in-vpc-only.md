...
This rule is covered by the [elasticsearch-in-vpc-only](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/elasticsearch/elasticsearch-in-vpc-only.sentinel) policy.
