...
This rule is covered by the [rds-ensure-automatic-minor-version-upgrades-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/rds/rds-ensure-automatic-minor-version-upgrades-enabled.sentinel) policy.
