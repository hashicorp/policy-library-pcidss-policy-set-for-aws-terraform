...
This rule is covered by the [eks-cluster-encrypted-kubernetes-secrets](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/eks/eks-cluster-encrypted-kubernetes-secrets.sentinel) policy.
