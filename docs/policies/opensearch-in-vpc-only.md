...
This rule is covered by the [opensearch-in-vpc-only](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/opensearch/opensearch-in-vpc-only.sentinel) policy.
