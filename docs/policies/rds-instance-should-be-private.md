...
This rule is covered by the [rds-instance-should-be-private](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/rds/rds-instance-should-be-private.sentinel) policy.
