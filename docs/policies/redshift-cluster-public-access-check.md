...
This rule is covered by the [redshift-cluster-public-access-check](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/redshift/redshift-cluster-public-access-check.sentinel) policy.
