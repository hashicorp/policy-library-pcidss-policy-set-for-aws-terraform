...
This rule is covered by the [guardduty-eks-protection-runtime-should-be-enabled](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/guardduty/guardduty-eks-protection-runtime-should-be-enabled.sentinel) policy.
