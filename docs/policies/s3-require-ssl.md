...
This rule is covered by the [s3-require-ssl](https://github.com/hashicorp/policy-library-pcidss-policy-set-for-aws-terraform/blob/main/policies/s3/s3-require-ssl.sentinel) policy.
